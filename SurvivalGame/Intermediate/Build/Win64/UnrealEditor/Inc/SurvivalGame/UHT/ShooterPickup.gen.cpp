...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"),&Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 922389142U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 3622714755U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_3573237519{
	TEXT("/Script/SurvivalGame"),
	Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Madison_OneDrive_Documents_Unreal_Projects_SurvivalGame_Source_SurvivalGame_Variant_Shooter_Weapons_ShooterPickup_h__Script_SurvivalGame_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
